...
type HelloWorldServiceClient interface {
	Greating(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error)
}
...
func (c *helloWorldServiceClient) Greating(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, "/api.HelloWorldService/Greating", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServiceServer interface {
	Greating(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error)
...
func (UnimplementedHelloWorldServiceServer) Greating(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Greating not implemented")
}
...
func _HelloWorldService_Greating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloWorldRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServiceServer).Greating(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.HelloWorldService/Greating",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).Greating(ctx, req.(*HelloWorldRequest))
	}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Greating",
			Handler:    _HelloWorldService_Greating_Handler,
		},
	},
